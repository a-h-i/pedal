...
BiQuadLowPass::BiQuadLowPass(float sample_rate, float cutoff_hz, float Q) : BiQuadFilter(sample_rate, cutoff_hz, Q) {
    set_params(cutoff_hz, Q);
}


void BiQuadLowPass::set_params(float cutoff_hz, float Q) {
